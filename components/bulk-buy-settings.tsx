      ...
      {options.map((option) => (
        <button
          ...
          className={cn(
            ...
            {
              "bg-green-500/20 dark:bg-green-500/30 text-green-600 dark:text-green-400 border-green-300 dark:border-green-600": bulkBuyOption === option && gameState.prestigeLevel === 0,
              "bg-purple-500/20 dark:bg-purple-500/30 text-purple-600 dark:text-purple-400 border-purple-300 dark:border-purple-600": bulkBuyOption === option && gameState.prestigeLevel > 0,
              "bg-neutral-100 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 border-neutral-300 dark:border-neutral-600 hover:bg-green-500/10 dark:hover:bg-green-500/20 hover:text-green-600 dark:hover:text-green-400 hover:border-green-300 dark:hover:border-green-600": 
                bulkBuyOption !== option && !isOptionDisabled(option) && gameState.prestigeLevel === 0,
              "bg-neutral-100 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 border-neutral-300 dark:border-neutral-600 hover:bg-purple-500/10 dark:hover:bg-purple-500/20 hover:text-purple-600 dark:hover:text-purple-400 hover:border-purple-300 dark:hover:border-purple-600": 
                bulkBuyOption !== option && !isOptionDisabled(option) && gameState.prestigeLevel > 0,
